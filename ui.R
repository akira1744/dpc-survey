        ...
        mainPanel(
          ...
          tabsetPanel(
            ...
            tabPanel(
              ...
              p('現在,2018年度~2024年度の7年間分のデータを格納しています。'),
              ...
              h3('データソース'),
              a('令和６年度DPC導入の影響評価に係る調査「退院患者調査」の結果報告について',href='https://www.mhlw.go.jp/stf/shingi2/newpage_00203.html'),
              br(),
              ...
              a('・参考資料1:分析対象データ',href='https://www.mhlw.go.jp/content/12404000/001682706.pdf'),
              br(),
              a('・参考資料2:集計条件について',href='https://www.mhlw.go.jp/content/12404000/001682707.pdf'),
              
              h4('DPC退院患者調査に参加していない病院のデータは含まれていません。'),
              p('DPC退院患者調査集計対象施設数は6372施設(2024年度)です。'),
